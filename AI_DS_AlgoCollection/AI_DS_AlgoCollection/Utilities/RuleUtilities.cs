...
{
    public static List<AssociationRule<TDataType>> CreateRulesFromItemSets<TDataType>(this List<ItemSet<TDataType>> frequentItemSets, float minConf, List<ItemSet<TDataType> > itemSetsOrigin) where TDataType : IComparable
    {
    ...
    private static List<AssociationRule<TDataType>> CreateRulesFromItemSet<TDataType>(ItemSet<TDataType> frequentItemSet, float minConf, List<ItemSet<TDataType> > itemSetsOrigin) where TDataType : IComparable
    {
